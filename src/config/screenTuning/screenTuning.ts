...
const kombiTuning = [
  { name: 'color_red_factor', value: '253', type: 'fixed8' },
  { name: 'color_green_factor', value: '253', type: 'fixed8' },
  { name: 'color_blue_factor', value: '256', type: 'fixed8' },
  { name: 'color_saturation_factor', value: '256', type: 'fixed8' },
];

const mib2Tuning = [
  { name: 'color_red_factor', value: '252', type: 'fixed8' },
  { name: 'color_green_factor', value: '252', type: 'fixed8' },
  { name: 'color_blue_factor', value: '256', type: 'fixed8' },
  { name: 'color_saturation_factor', value: '256', type: 'fixed8' },
]
